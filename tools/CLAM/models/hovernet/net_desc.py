...
class HoVerNet(Net):
    ...
    def __init__(self, input_ch=3, nr_types=None, freeze=True, mode='original'):
        super().__init__()
        self.mode = mode
        self.freeze = freeze
    ...
    def forward(self, imgs, return_features=True):
        ...
        if return_features:
            ...
            feature_vector = global_pooling(d3).view(d3.size(0), -1)
